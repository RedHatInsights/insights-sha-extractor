...
COMPONENT_NAME="ccx-sha-extractor"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
IMAGE="quay.io/cloudservices/ccx-sha-extractor"
COMPONENTS="ccx-data-pipeline ccx-insights-results insights-content-service insights-results-smart-proxy ccx-sha-extractor"  # space-separated list of components to load
